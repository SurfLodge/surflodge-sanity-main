export const tokenFields = [
    {
        ...
        description:
            'This id is used to fetch data from coingecko. Most of the time it is the last segment of the coingecko url, ie: coingecko.com/en/coins/surflodge has an ID of surflodge. IMPORTANT: Once you\'ve entered an id, select "Import coingecko data" from the document actions to pre-populate a lot of the data.',
        type: 'string',
    },
    {
        name: 'name',
